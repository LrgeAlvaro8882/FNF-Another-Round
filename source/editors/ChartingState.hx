...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Flash Cam', "Value 1: Color (ex: FFFFFF for white, 000000 for black).\nValue 2: Duration. If blank, Duration = 0.3 ."],
		['Set Cam Zoom', "Value 1: Zoom. If blank, Zoom = 0.9 .\nValue 2: Duration. If blank, Duration = 1."],
		['Cam Boom Speed', "Value 1: Speed. If blank, Speed = Each 4 beats.\nValue 2: Intensity of boom. If blank, Intensity = default."],
		['CamControlShit', "Value 1: Pos. (x, y).\nValue 2: Zoom."],
		['Play Sound', "Value 1: Name. Value 2: Volume."]
	];
