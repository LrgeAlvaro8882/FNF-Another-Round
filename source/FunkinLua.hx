...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('healthDrain', PlayState.instance.healthDrain);
		...
		set('noBg', ClientPrefs.noBg);
		set('gainableHealth', PlayState.instance.gainableHealth);
		set('loseableHealth', PlayState.instance.loseableHealth);
		set('noteStyleType', ClientPrefs.noteType);
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'shift': key = FlxG.keys.justPressed.SPACE;//another extra key for convinience
			}
			return key;
		});
